...
HD_PWD='C:/Users/Administrator/Desktop/recent/final/project_final/project_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dec_viterbi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dec_viterbi.tcl -notrace
